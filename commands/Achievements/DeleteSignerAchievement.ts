...
export default class DeleteSignerAchievement extends BaseCommand {
   ...
   */
  public static commandName = 'delete:signer:achievement'
  /**
   * Command description is displayed in the "help" output
   */
  public static description = 'This command delete signer achievement'

  private nameFileBackup: string = 'delete-signer-achivement.json'
  ...
  public async execute(): Promise<void> {
    ...
    let deleteAchievementSigner = JSON.parse(data.body.toString('utf-8'))

    for (const item of deleteAchievementSigner) {
      ...
      i = this.processingProgressBar(i, deleteAchievementSigner.length)
    }

...
export default class VerifyProtectedAreasByIdCrop extends BaseCommand {
  /**
   * Command name is used to run the command
   */
  public static commandName = 'verify:protected:areas:by:id:crop'

  /**
   * Command description is displayed in the "help" output
   */
  public static description = 'verify protected area by id crop'

  @args.string({ description: 'Attribute crop Id to send' })
  public cropId: string

  @flags.boolean({ alias: 'r', description: 'Rollback flag' })
  public rollbackCommand: boolean

  private nameFileBackup: string = 'verify-protected-area-crop-id.json'
    ...
    const pipeline: Array<any> = [
      {
        $match: {
          cancelled: false,
          _id: Types.ObjectId(this.cropId),
          dateCrop: {
